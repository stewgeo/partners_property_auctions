...
function AuctionTheme_do_login_scr()
		...
		do_action( 'login_init' );
		  ...
		  switch($_REQUEST["action"])
		  {
			...
			global $real_ttl;
			$real_ttl = __("Retrieve Password", $current_theme_locale_name);			
		...
		?>
				<div class="my_box3">
            	<div class="box_title"><?php _e("Retrieve Password",$current_theme_locale_name); ?> - <?php echo  get_bloginfo('name'); ?></div>
		...
		<?php
			...
			case 'retrievepassword2': 
				...
				global $real_ttl;
				$real_ttl = __("Retrieve Error", $current_theme_locale_name);			
				add_filter( 'wp_title', 'AuctionTheme_sitemile_filter_ttl', 10, 3 );	
			...
			case 'rp' :
				...
				global $real_ttl;
				$real_ttl = __("Key Not Valid", $current_theme_locale_name);			
				add_filter( 'wp_title', 'AuctionTheme_sitemile_filter_ttl', 10, 3 );	
			...
			default:
			  ...
			  //Any differences will be noted with end of line comments. 
				...
				global $real_ttl;
				$real_ttl = __("Login", $current_theme_locale_name);			
				add_filter( 'wp_title', 'AuctionTheme_sitemile_filter_ttl', 10, 3 );	
