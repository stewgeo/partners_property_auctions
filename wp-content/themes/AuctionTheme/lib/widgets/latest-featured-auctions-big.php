...
class AuctionTheme_latest_posted_ads_big2 extends WP_Widget {
	...
	function AuctionTheme_latest_posted_ads_big2() {
		...
		$this->WP_Widget( 'latest-posted-auctions-big2', 'AuctionTheme - Featured auctions (big)', $widget_ops, $control_ops );
	}
	...
	function form($instance) { ?>
		...
		<p>
			<label for="<?php echo $this->get_field_id('show_auctions_limit'); ?>"><?php _e('Show auction limit'); ?>:</label>
