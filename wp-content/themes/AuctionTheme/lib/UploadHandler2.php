...
class UploadHandler_AT
{
    ...
    protected function set_file_delete_properties($file, $att_id = '') {
        ...
        if ($this->options['access_control_allow_credentials']) {
		 ...
		 $file->delete_url = get_bloginfo('siteurl') . "/?del_att=" . $att_id;
    ...
    protected function get_file_object($attach_id) {
	   ...
	   $post = get_post($attach_id);
			...
			$file->url = $this->AuctionTheme_wp_get_attachment_image($attach_id, 'small_uplo');	
			$file->thumbnail_url = $this->AuctionTheme_wp_get_attachment_image($attach_id, 'small_uplo');	

           
            $this->set_file_delete_properties($file, $attach_id);
	...
	protected function AuctionTheme_wp_get_attachment_image($attachment_id, $size = 'thumbnail', $icon = false, $attr = '') {
    ...
    protected function handle_file_upload($uploaded_file, $name, $size, $type, $error, $index = null, $content_range = null) 
	{
		...
		$super_arr['name'] 		= $name;
		$super_arr['type'] 		= $type;
		$super_arr['tmp_name'] 	= $uploaded_file;
		$super_arr['error'] 	= $error;
		$super_arr['size'] 		= $size;
        ...
        if ($this->validate($uploaded_file, $file, $error, $index)) 
		{
            ...
            if ($uploaded_file && is_uploaded_file($uploaded_file)) 
			{
				...
				$uploaded_file_m 		= wp_handle_upload($super_arr, $upload_overrides);
						
				$file_name_and_location 		= $uploaded_file_m['file'];
