...
$twitter_enabled 	= get_option('AuctionTheme_enable_twitter_login');
$consumer_key 		= get_option('AuctionTheme_twitter_consumer_key');
$consumer_secret 	= get_option('AuctionTheme_twitter_consumer_secret');
...
?>
<p>AuctionTheme plugin has not been configured for Twitter</p>
