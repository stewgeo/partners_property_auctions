...
class UploadHandler_AuctionTheme
{
    protected $options;
    ...
    protected function get_file_object($ppid) {
        $post = get_post($pid);
            ...
            $file->url = AuctionTheme_generate_thumb(wp_get_attachment_url($pid),70,70);
			$file->{'thumbnail_url'} = AuctionTheme_generate_thumb(wp_get_attachment_url($pid),70,70);
