...
<?php /*?>                    <li><a href="<?php echo get_page_link(1375); ?>"><?php echo get_the_title(1375)?></a></li>  
<?php */?>                    <li><a href="<?php echo get_page_link(1287); ?>"><?php echo get_the_title(1287)?></a></li>  
                    ...
                    <li><a href="<?php echo get_page_link(1621); ?>"><?php echo get_the_title(1621)?></a></li>  
