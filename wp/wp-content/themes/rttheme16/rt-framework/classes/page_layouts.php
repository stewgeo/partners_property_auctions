...
class RTThemePageLayouts extends RTThemeAdmin{
	...
	function __construct(){   
		...
		// Items
		$rt_items          = array("slider_box"=>"Slider","blog_box" => "Blog Posts","contact_info_box" => "Contact Info","contact_form" => "Contact Form","google_map" => "Google Map","all_content_boxes" => "Home Page Content","portfolio_box" => "Portfolio","product_box" => "Product","sidebar_box" => "Widget Area - Sidebar","default_content"=>"Default Content + Page Title","banner_box"=>"Banner Box");
								...
								"part"            => "first"));		
												...
												if(is_array($template->contents)){
														foreach($template->contents as $templateContents){
															...
															$templateContents->box_border  = isset($templateContents->box_border) ? $templateContents->box_border : "";															
															$templateContents->button_text  = isset($templateContents->button_text) ? $templateContents->button_text : "";			
															$templateContents->button_color  = isset($templateContents->button_color) ? $templateContents->button_color : "";			
															$templateContents->button_size  = isset($templateContents->button_size) ? $templateContents->button_size : "";			
															$templateContents->widget_border  = isset($templateContents->widget_border) ? $templateContents->widget_border : "";															
															...
															if($templateContents->content_type=="portfolio_box"){
																...
																array_push($options,	array( 
																		...
																		"options"      => array('group_id'=>$templateContents->group_id, 'layout'=>$templateContents->layout, 'categories'=>$templateContents->categories , 'pagination'=>$templateContents->pagination ,'box_border'=>$templateContents->box_border, 'item_width'=>$templateContents->item_width , 'portf_list_orderby'=>$templateContents->portf_list_orderby, 'portf_list_order'=>$templateContents->portf_list_order , 'item_per_page'=>$templateContents->item_per_page ),
																		"purpose"      => "page_layouts",
															...
															if($templateContents->content_type=="sidebar_box"){
																...
																array_push($options,	array( 
																		...
																		"options"      => array('group_id'=>$templateContents->group_id, 'layout'=>$templateContents->layout, 'sidebar_id'=>$templateContents->sidebar_id, 'widget_box_width'=>$templateContents->widget_box_width,  'widget_border'=>$templateContents->widget_border),
																		"purpose"      => "page_layouts",
															...
															if($templateContents->content_type=="all_content_boxes"){
																...
																array_push($options,	array( 
																		...
																		"options"      => array('group_id'=>$templateContents->group_id, 'layout'=>$templateContents->layout, 'content_id'=>$templateContents->content_id, 'box_border'=>$templateContents->box_border, 'item_width'=>$templateContents->item_width , 'list_orderby'=>$templateContents->list_orderby, 'list_order'=>$templateContents->list_order ),
																		"purpose"      => "page_layouts",
															...
															if($templateContents->content_type=="banner_box"){
																...
																array_push($options,	array( 
																		...
																		"options"      => array('group_id'=>$templateContents->group_id, 'layout'=>$templateContents->layout, 'text'=>stripslashes($templateContents->text), 'button_text'=>$templateContents->button_text, 'button_color'=>$templateContents->button_color, 'button_link'=>$templateContents->button_link, 'button_size'=>$templateContents->button_size),
																		"purpose"      => "page_layouts",
															...
															if($templateContents->content_type=="product_box"){
																...
																array_push($options,	array( 
																		...
																		"options"      => array('group_id'=>$templateContents->group_id,'layout'=>$templateContents->layout,  'item_width'=>$templateContents->item_width, 'box_border'=>$templateContents->box_border, 'pagination'=>$templateContents->pagination, 'list_orderby'=>$templateContents->list_orderby, 'list_order'=>$templateContents->list_order, 'categories'=>$templateContents->categories, 'item_per_page'=>$templateContents->item_per_page),
																		"purpose"      => "page_layouts",
															...
															if($templateContents->content_type=="contact_form"){
																...
																array_push($options,	array( 
																		...
																		"options"      => array('group_id'=>$templateContents->group_id,'layout'=>$templateContents->layout, 'title'=>stripslashes($templateContents->title), 'email'=>$templateContents->email, 'shortcode'=>stripslashes($templateContents->shortcode),  'box_border'=>$templateContents->box_border,  'description'=>stripslashes($templateContents->description)),
																		"purpose"      => "page_layouts",
