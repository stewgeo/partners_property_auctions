...
class RTSetupAssistant{
	...
	function __construct(){     
		...
		//Screenshot URL
		$screenshotURL = "http://templatemints.com/theme_screenshots/rt-theme16/index.php";
		...
		$contents->step[$step_count]->title  = 'Build Home Page';
				...
				Your home page uses "Default Home Page Tempale" as template, if you have not chaged your Reading settings and defined another page as your home page! (Settings → Reading → Front page displays)
				<br /><br />
