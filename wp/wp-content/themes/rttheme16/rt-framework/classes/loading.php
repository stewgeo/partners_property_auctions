...
class RTTheme{
	...
	function theme_constants($v) {
		...
		define( 'NOTIFIER_THEME_FOLDER_NAME', 'rttheme16' );  
		define( 'NOTIFIER_XML_FILE', 'http://templatemints.com/theme_updates/rttheme16/notifier.xml' ); 
		define( 'NOTIFIER_CACHE_INTERVAL', 21600 );
		
		//unique theme name for default settings
		define('UTHEMENAME', "RTTHEME16");
